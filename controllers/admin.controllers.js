  ...
  if(req.session.user) {
    ...
    if (req.method === 'POST') {
      ...
      if(password !== cpassword){
        return res.render('admin/password_reset', {
          layout: false,
          error: true,
          message: 'Passwords do not match',
          redirectLink: 'admin/password_reset'
        });
      } else {
    ...
    res.render('admin/password_reset', {
...
const sectorResponses = async (req, res) => {
  ...
  if (req.session.user) {
    ...
    res.render('admin/section_response', {
      title: 'Dashboard',
      layout: false,
      financial,
      tele,
  ...
  if (req.session.user) {
    ...
    try {
      ...
      res.render('admin/message',
      {
        ...
        redirectLink: 'admin/add-questions'
      })
    }
  } else return res.redirect('/admin/login');
}
